...
data class UserApiModel(val id: String, val name: String, val surname: String, val email: String, val address: AddressApiModel, val phone: String, val website: String, val company: CompanyApiModel)
